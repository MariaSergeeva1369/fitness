...
/* harmony import */ var _modules_tubs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/tubs */ "./js/modules/tubs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_text__WEBPACK_IMPORTED_MODULE_1__["changeTitleText"])();
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_tubs__WEBPACK_IMPORTED_MODULE_3__["selectTab"])();
    Object(_modules_tubs__WEBPACK_IMPORTED_MODULE_3__["removeNojsClass"])(_modules_tubs__WEBPACK_IMPORTED_MODULE_3__["tubsTitles"]);
    Object(_modules_tubs__WEBPACK_IMPORTED_MODULE_3__["removeNojsClass"])(_modules_tubs__WEBPACK_IMPORTED_MODULE_3__["tubsContent"]);
    Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_5__["validatePhoneInput"])();
    Object(_modules_feedback__WEBPACK_IMPORTED_MODULE_6__["setFeedbackListHeight"])();
  });
});
...
/*!********************************!*\
  !*** ./js/modules/feedback.js ***!
  \********************************/
/*! exports provided: setFeedbackListHeight */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setFeedbackListHeight", function() { return setFeedbackListHeight; });
var feedbackButtons = document.querySelectorAll('[data-feedback-button]');
var feedbackList = document.querySelector('[data-feedback-list]');
var setFeedbackListHeight = function setFeedbackListHeight() {
  if (feedbackList) {
    var activeFeedbackSlide = document.querySelector('.feedback__item.swiper-slide-active');
    var slideHeight = activeFeedbackSlide.clientHeight;
    feedbackList.style.height = "".concat(slideHeight, "px");
  }
};
if (feedbackButtons) {
  for (var i = 0; i < feedbackButtons.length; i++) {
    var feedbackButton = feedbackButtons[i];
...
/*!***************************************!*\
  !*** ./js/modules/form-validation.js ***!
  \***************************************/
/*! exports provided: validatePhoneInput */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validatePhoneInput", function() { return validatePhoneInput; });
...
var onPhoneInput = function onPhoneInput(evt) {
  ...
  var formattedValue = firstSymbols;
...
var sliderTrainersList = document.querySelector('.swiper');
var sliderFeedbackList = document.querySelector('.swiper-feedback');
if (sliderTrainersList) {
  var mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderTrainersList, {
    loop: true,
    navigation: {
...
if (sliderFeedbackList) {
  var FeedbackSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderFeedbackList, {
    slidesPerView: 1,
    spaceBetween: 40,
    loop: false,
    navigation: {
...
/*!****************************!*\
  !*** ./js/modules/text.js ***!
  \****************************/
/*! exports provided: changeTitleText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./js/modules/tubs.js ***!
  \****************************/
/*! exports provided: selectTab, removeNojsClass, tubsContent, tubsTitles */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tubsContent", function() { return tubsContent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tubsTitles", function() { return tubsTitles; });
var tubsTitles = document.querySelectorAll('[data-tubs-title]');
var tubsContent = document.querySelectorAll('[data-tubs-list]');
...
var selectTab = function selectTab() {
  if (tubsTitles.length >= 1) {
    var _loop = function _loop(i) {
      var tubTitle = tubsTitles[i];
      var tubContent = tubsContent[i];
      tubTitle.addEventListener('click', function (evt) {
        evt.preventDefault();
        tubsTitles.forEach(function (tub) {
          tub.classList.remove('is-active');
        });
        tubsContent.forEach(function (content) {
    ...
    for (var i = 0; i < tubsTitles.length; i++) {
      _loop(i);
    }
  }
};
